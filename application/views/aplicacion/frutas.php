            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <!--<div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <img width="30%" src="<?php echo base_url().'public/images/modal/student1.png'?>" class="center-block img-circle">
                    </div>-->
                </div>
            </div>
        </div>
        ...
        function compra(){
            if(puntos <50){
                ...
                bootbox.confirm({
                    ...
                    message: "<p class='text-center'>Seguro quieres comprar?.<br><p>"+"<strong>"+nombre+"</strong>"+" por 50 puntos<br>"+"Tus puntos actuales son: "+puntos,
