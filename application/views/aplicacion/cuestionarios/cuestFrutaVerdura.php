<div class="container">
    <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <figure>
            <img alt="estudiante1" class="img-circle pull-left icon-inst" style="margin-top: 15px" src="<?php echo base_url().'public/images/modal/student1.png'?>">
        </figure>
    </div>
</div>
<br>
...
<div class="container cuadradosombracuest">
    ...
    <div class="row" style="margin-bottom: 15px">
            ...
            <div  class="col-md-4">
                ...
                <figure>
                    <img alt="estudiante1" class="img-circle pull-left" width="20%" style="margin-top: 15px" src="<?php echo base_url().'public/images/modal/student1.png'?>">
                </figure>
            </div>
    </div>
            <?php
