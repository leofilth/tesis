<div class="container">
    <div class="col-md-8 col-xs-12 col-sm-12">
        ...
        <figure>
            <img alt="estudiante4" class="img-circle pull-left icon-inst" style="margin-top: 15px" src="<?php echo base_url().'public/images/modal/student4.png'?>">
        </figure>
    </div>
</div>
<br>
    ...
    foreach($preguntasAlimento as $pregunta){
        ...
        <div class="row" style="margin-bottom: 15px">
            ...
            <div  class="col-md-4">
                ...
                <figure>
                    <img alt="estudiante4" class="img-circle pull-left" style="width:20%;margin-top: 15px" src="<?php echo base_url().'public/images/modal/student4.png'?>">
                </figure>
            </div>
        </div>
        <?php
