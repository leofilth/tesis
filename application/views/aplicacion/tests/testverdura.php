...
if($cuestRespondidos!=null) {
    $limpio = $this->mis_funciones->limpia2($cuestRespondidos);
    foreach ($aux as $cuestionario) {?>
        ...
        <?php }
            ...
            <div class="col-md-6">
                <h3 class="titulo4 text-center">Test <?php echo $i ?></h3>
                <?php $numero = intval(preg_replace('/[^0-9]+/', '', $cuestionario), 10); ?><!--obtiene solo el o los numeros de la cadena-->
                <a href="<?php echo base_url() . "aplicacion/cuestionario/" . $numero ?>"><img
                        style="height: 120px;width: 120px;cursor: pointer" class="cuestionario center-block"
