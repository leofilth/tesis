...
<section class="container-fluid padingtop" id="section1">
    <div  class="container">
        <header data-aos="flip-up" class="tituloSection">frutas y verduras Wambo</header>
                        ...
                        if($misfrutas!=null) {
                            ...
                            foreach ($frutas as $fruta) {
                                if (in_array($fruta->id, $misfrutas_limpio)) {
                                    ?>
                                    <div data-aos="zoom-in" class="col-md-2 col-sm-2 col-xs-3" style="padding-bottom: 10px">
...
<section class="container-fluid animated fadeIn" id="section2">
    ...
    <div class="padingtop">
        <img data-aos="fade-down" class="ir-arriba animated infinite pulse center-block tamano" alt="flechaTop" src="<?php echo base_url()."public/images/icons/up-arrow.png"?>">
    </div>
</section>
