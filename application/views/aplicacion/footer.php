        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="textofooter">
                    ...
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
                        <a href="<?php echo base_url()."aplicacion/aceitegrasas"?>">Wambo Aceites y Grasas</a>
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
                    ...
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
                        <a href="<?php echo base_url()."aplicacion/cereales"?>">Wambo Cereales</a>
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="textofooter">
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
                        <a href="<?php echo base_url()."aplicacion/alimentos"?>">Wambo Carne, Lacteos, Huevos y Legumbres</a>
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-link"></span>
