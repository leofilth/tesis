            ...
            <div class="modal-body" style="background-color: #673AB7">
                <div class="tip-modal avatar" id="informacion">
                    <div class="margen-modal">
                        ...
                        <figure>
                            <img id="modalimg" style="width:15%;position:absolute;top:10px;right:10px;margin:0;" alt="cereal" class="zoom fondofruta borde img-circle" src="#">
                        </figure>
                    </div>
                    <figure>
                ...
                <br>
                <figure>
                    <img alt="estudiante3" class="img-circle" style="width: 20%" src="<?php echo base_url().'public/images/modal/student3.png'?>">
                </figure>
